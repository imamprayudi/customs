<!-- ======= Footer ======= -->
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>JVCKENWOOD</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
    Designed by <a href="https://jkei.jvckenwood.com/">JVCKENWOOD</a>
    </div>
  </footer><!-- End Footer -->
  ...
  <script src="../dist/tinymce.bundle.js"></script>
